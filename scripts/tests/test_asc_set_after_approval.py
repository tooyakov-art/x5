...
class SetAfterApprovalContractTests(unittest.TestCase):
    ...
    def test_release_audit_workflow_exposes_explicit_guarded_action(self):
        self.assertEqual(load_script().EXPECTED_BUILD, "242")
        ...
        self.assertIn('EXPECTED_VERSION: "1.1.11"', workflow)
        self.assertIn('EXPECTED_BUILD: "242"', workflow)
